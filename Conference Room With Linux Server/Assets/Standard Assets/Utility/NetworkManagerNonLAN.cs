...
//	Network.natFacilitatorIP = 13.82.52.184;
//	Network.natFacilitatorPort = <facilitator port>;
	...
	private void StartServer()
	{
		...
		//useNat = false
		////#########################################
		////######USE THIS FOR THE LINUX SERVER######
//		MasterServer.ipAddress = "13.82.52.184";
//		MasterServer.port = 8080;

		//Network.InitializeServer (16, 8080, false);
		////#########################################
		////#########################################
	...
	{
	//	NetworkStartPosition playerSpawn = spawnPoints [Random.Range (0, spawnPoints.Length)];
		Debug.Log ("Spawning Player...");
		GameObject player = (GameObject)Network.Instantiate (Resources.Load ("Player"), new Vector3(0f, 2.5f, 0f), Quaternion.identity, 0);
